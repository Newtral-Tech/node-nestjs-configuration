...
export interface ConfigurationModuleResult<T extends JSONSchema7> {
  ...
  ): (target: Object, propertyKey: string | symbol | any, parameterIndex?: number) => void;

  /** Inject the whole configuration object. The type for this object is `Configuration<schema>` */
  InjectConfiguration(): (target: Object, propertyKey: string | symbol | any, parameterIndex?: number) => void;
}
